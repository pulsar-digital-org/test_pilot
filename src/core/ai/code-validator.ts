...
export class CodeValidator {
    ...
    extractCode(llmResponse: string): string {
        ...
        for (const line of lines) {
            ...
            if (line.includes('import') || line.includes('describe') || line.includes('test') || line.includes('expect')) {
                inCodeSection = true;
            }
            
            // Stop at explanatory text after code
            if (inCodeSection && (line.includes('This test') || line.includes('The test') || line.includes('These tests'))) {
                break;
            }
     ...
     */
    generateRetryPrompt(originalPrompt: string, errors: readonly string[]): string {
